...
import { cn } from '@/lib/utils'; // Assuming a utils file with cn
...
export function Leaderboard({ scores, title }: LeaderboardProps) {
  return (
    <div className="w-full max-w-2xl mx-auto p-6 bg-white rounded-3xl shadow-xl border border-gray-100" dir="rtl">
      <h2 className="text-3xl font-black text-center text-gray-800 mb-8">{title}</h2>
          ...
          scores.map((score, index) => (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                {/* Note: in real app replace user_id with nickname from profiles */}
              </div>
